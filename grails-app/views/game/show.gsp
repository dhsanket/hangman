	...
	<body>
		...
		<div id="show-game" class="content scaffold-show" role="main">
			...
			<ol class="property-list game">
				...
				<g:if test="${gameInstance?.userId}">
				<li class="fieldcontain">
					<span id="userId-label" class="property-label"><g:message code="game.userId.label" default="User Id" /></span>
					
						<span class="property-value" aria-labelledby="userId-label"><g:fieldValue bean="${gameInstance}" field="userId"/></span>
